...
# PURPOSE: generate temperature metrics
# NOTES:
#==========================================================================================================================================#
...
temp <- read_csv("Temperature/TemperatureData_Daily.csv")
...
##---------------------------------------------------------------------------------------##
## data figures for focal streams/sites
##---------------------------------------------------------------------------------------##
...
# fudge sampling dates for Mosquito Creek in 2021 to enable calculation of temp metrics (we didn't sample Mosquito in 2021)
